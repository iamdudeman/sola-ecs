...
@NullMarked
class ViewNTest extends ViewNTestBase {
  private ViewN view;
  ...
  class createEntryFromEntity {
    ...
    void whenAllComponentsPresent_shouldReturnEntity() {
      ...
      assertNotNull(entry);
      assertEquals(testComponent, entry.c(0));
      assertEquals(testComponent2, entry.c(1));
      assertEquals(testComponent3, entry.c(2));
      assertEquals(testComponent4, entry.c(3));
    }
